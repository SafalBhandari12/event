...
const Footer = () => {
  ...
  const handleNewsletterSubmit = (e: React.FormEvent) => {
    ...
    alert(`Thank you for subscribing with ${email}! We'll keep you updated on future Flow Party events.`);
    setEmail('');
  };
      ...
      <div className="container mx-auto px-6 py-16 relative z-10" ref={ref}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          >
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="font-heading font-bold text-2xl text-white">Flow Party</span>
            </div>
            <p className="text-white/70 font-body leading-relaxed mb-6">
              Creating unforgettable experiences where music, art, and community come together 
              in perfect harmony. Join the flow.
            </p>
          ...
          >
            <h3 className="font-heading font-bold text-xl text-white mb-6">Legal</h3>
            <ul className="space-y-3">
          ...
          >
            <h3 className="font-heading font-bold text-xl text-white mb-6">Stay Updated</h3>
        ...
        >
          <p className="text-white/60 font-body text-sm">
            © 2024 Flow Party. All rights reserved. Made with ❤️ for the music community.
          </p>
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white/60 font-body text-xs">Flow Events</span>
            </div>
          </div>
        </motion.div>
      </div>
