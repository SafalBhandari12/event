...
const galleryImages: GalleryImage[] = [
  { src: '/assets/gallery1.svg', alt: 'Flow Party 2023 - Main Stage', photographer: 'Alex Chen' },
  { src: '/assets/gallery2.svg', alt: 'Crowd enjoying DJ Zen performance', photographer: 'Maria Santos' },
  { src: '/assets/gallery3.svg', alt: 'Neon light installation', photographer: 'David Kim' },
  { src: '/assets/gallery4.svg', alt: 'VIP area atmosphere', photographer: 'Sarah Johnson' },
  { src: '/assets/gallery5.svg', alt: 'Luna Verde live performance', photographer: 'Mike Wilson' },
  { src: '/assets/gallery6.svg', alt: 'After party vibes', photographer: 'Emma Davis' },
];
        ...
        >
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-black/50 backdrop-blur-sm rounded-lg p-4">
              <h3 className="text-white font-body font-semibold mb-1">{currentImage.alt}</h3>
              {currentImage.photographer && (
                <p className="text-white/70 font-body text-sm">Photo by {currentImage.photographer}</p>
              )}
...
const GalleryItem = ({ image, index, onClick }: { image: GalleryImage; index: number; onClick: () => void }) => {
      ...
      >
        ...
        >
          <div className="p-4 w-full">
            <p className="text-white font-body font-semibold text-sm mb-1">{image.alt}</p>
            {image.photographer && (
              <p className="text-white/70 font-body text-xs">Photo by {image.photographer}</p>
            )}
          </div>
        </motion.div>
...
const Gallery = () => {
  ...
  return (
    <section id="gallery" className="py-20 px-6 bg-[var(--bg-mid)] relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto max-w-7xl relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="font-body text-lg md:text-xl text-white/80 max-w-2xl mx-auto">
            Relive the magic from previous Flow Party events and get excited for what's to come
          </p>
        </motion.div>
