...
const Location = () => {
  ...
  return (
    <section id="location" className="py-20 px-6 bg-[var(--bg-dark)] relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto max-w-6xl relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="font-body text-lg md:text-xl text-white/80 max-w-2xl mx-auto">
            Join us at the stunning Riverside Amphitheater for an unforgettable night under the stars
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="glass rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-body font-semibold text-white mb-1">Address</h4>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-body font-semibold text-white mb-1">Event Time</h4>
                    <p className="text-white/70 font-body">
                      Saturday, August 30th<br/>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-body font-semibold text-white mb-1">Capacity</h4>
                    <p className="text-white/70 font-body">
                      5,000 attendees<br/>
                      Indoor/outdoor venue<br/>
                      All weather covered
                    </p>
                  </div>
                </div>
            ...
            >
              <h4 className="font-heading font-bold text-xl text-white mb-4">Getting There</h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white/80 font-body text-sm">Free Parking Available</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white">
                  ...
                  <span className="text-white/80 font-body text-sm">Metro: Central Station</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white">
                  ...
                  <span className="text-white/80 font-body text-sm">Ride Share Drop-off</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white">
                  ...
                  <span className="text-white/80 font-body text-sm">Shuttle Service</span>
                </div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="glass rounded-2xl p-8 h-96 flex items-center justify-center relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <h4 className="font-heading font-bold text-xl text-white mb-2">Interactive Map</h4>
            ...
            <div className="mt-6 glass rounded-lg p-4">
              <p className="text-white/60 font-body text-xs">
                <strong>Setup Instructions:</strong> Replace this placeholder with:
