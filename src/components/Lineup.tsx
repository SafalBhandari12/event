    ...
    >
      ...
      >
        ...
        <div className="p-6">
          ...
          <p className="text-[var(--accent-cyan)] font-body font-semibold mb-2">{artist.genre}</p>
          <p className="text-[var(--muted)] font-body text-sm mb-4">{artist.time}</p>
          ...
          >
            <p className="text-white/70 font-body text-sm leading-relaxed">{artist.bio}</p>
          </motion.div>
        </div>
      </motion.div>
    </motion.div>
...
const Lineup = () => {
  ...
  return (
    <section id="lineup" className="py-20 px-6 bg-[var(--bg-dark)] relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto max-w-7xl relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="font-body text-lg md:text-xl text-white/80 max-w-2xl mx-auto">
            Experience world-class artists bringing their unique sounds to create an unforgettable musical journey
          </p>
        </motion.div>
